...
1 尝试通过get请求挖一块 http://localhost:5000/mine

2 发起 post 请求到 http://localhost:5000/transactions/new 创建一次新的交易
post 请求内容如下（例子）
{
    “sender”: “25191d383d464660be71d63fd0c06f73”, 
    “recipient”: “someone-other-address”, 
    “amount”: 5 
}

如果没有用 postman，也可用curl发起相同的请求：
...
3 查看完整的链条 http://localhost:5000/chain
"""